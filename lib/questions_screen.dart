    ...
    return SizedBox( // A SizedBox is a widget that has a specific size. Here we are using it to make the child widget take up the full width of the screen.
      ...
      child: Column(
        ...
        Text(
          ...
          textAlign: TextAlign.center, // Here we are displaying the text of the current question. The currentQuestion variable is an instance of the Question class, which is defined in data/questions.dart. The text property of the Question class contains the text of the question.
